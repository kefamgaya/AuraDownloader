...
import gain.aura.ui.component.DialogSingleChoiceItemVariant
import gain.aura.ui.component.DialogSubtitle
import gain.aura.ui.component.DialogSwitchItem
...
import gain.aura.ui.component.SealTextField
import gain.aura.ui.page.downloadv2.configure.PreferencesMock
...
import gain.aura.util.CONVERT_SUBTITLE
import gain.aura.util.CONVERT_VTT
import gain.aura.util.DEFAULT
import gain.aura.util.DownloadUtil
import gain.aura.util.FORMAT_COMPATIBILITY
import gain.aura.util.FORMAT_QUALITY
import gain.aura.util.M4A
import gain.aura.util.NOT_CONVERT
import gain.aura.util.NOT_SPECIFIED
import gain.aura.util.OPUS
...
import gain.aura.util.RES_LOWEST
import gain.aura.util.SUBTITLE_LANGUAGE
import gain.aura.util.ULTRA_LOW
import gain.aura.util.getStringDefault
